...
class MatchManager:
    ...
    def create_matches_next_round(self, round_obj, player_list):
        """Créé la liste des matchs pour les rounds suivants le premier"""
        sorted_list = sorted(players_list, key=lambda player: int(player.score), reverse=True)
        match_list = []
